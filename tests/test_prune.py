...
def test_random_van_dung_so_luong_va_giu_thu_tu():
    e = _emb(100)
...
def test_phuong_phap_la_thi_bao_loi():
    try:
        select(_emb(), 0.5, "khong-ton-tai")
        assert False, "đáng lẽ phải báo lỗi"
    except ValueError:
        pass
